...
const AddProduct = () => {
  function onSubmit(event: any): void {
    ...
    let productData: productData = {
      userID: userId,
      productTitle: (document.getElementById("title") as HTMLInputElement)
        .value,
      categoryID: (document.getElementById("category") as HTMLInputElement)
        .value,
    ...
    axios
      .post("https://609cc6bd04bffa001792d455.mockapi.io/products", productData)
      .then((response) => {
