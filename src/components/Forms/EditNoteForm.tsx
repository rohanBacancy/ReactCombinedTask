...
const editNoteFrom = (props: any) => {
    ...
    return (
        <Form onSubmit={onSubmit}>
            <FormGroup>
                <Label>Title</Label>
                <Input type="text" id="title" placeholder="enter title" value={title}></Input>
            </FormGroup>
            <br />
            <FormGroup>
                <Label>Description</Label>
                <Input type="textarea" id="description" placeholder="enter description" value={description}></Input>
            </FormGroup>
            <br />
            <FormGroup>
            ...
            <br />
            <FormGroup>
                <Button color="primary" type="submit">Edit Note</Button>
            </FormGroup>
        </Form>
    )
}
